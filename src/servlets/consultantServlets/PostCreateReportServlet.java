...
@WebServlet(name = "PostCreateReportServlet", urlPatterns = {"/consultant/logged/adding_report"})
public class PostCreateReportServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (!isFormProperlyFilled) {
            getServletContext().getRequestDispatcher("/consultant/logged/create_report").forward(request, response);
        } else {
            ...
            int reportId = ReportOperations.insertReport(report);
            ReportOperations.insertCommentForReport(reportId, report.getComment());
