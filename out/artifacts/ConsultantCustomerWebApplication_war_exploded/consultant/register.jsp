<%
    String title = "Register a new Consultant";
%>
...
<div class="content">
    <form action="<%=request.getContextPath()%>/consultant/register" method="post">
        <fieldset>
            <legend>Consultant Registration</legend>
            ...
            %>
            <label for="hourlyWage">Hourly Wage ( in Bulgarian lev ):</label>
            <br>
            <input type="text" name="hourlyWage" id="hourlyWage" placeholder="Hourly Wage"
                   pattern="^[0-9]+$" required>
            <br>
            <%
                if(request.getAttribute("hourlyWageError") != null)
                    out.print("<p class=\"errorText\">" + request.getAttribute("hourlyWageError") + "</p><br>");
            %>
            <label for="rank">Choose your rank as a consultant</label>
            <br>
            <select name="rank" id="rank">
                <option value="3" selected>Junior Consultant</option>
    ...
    You already have a consultant profile?
    <br>
