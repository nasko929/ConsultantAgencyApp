<%
    String title = "Login into the Consultant System";
%>
...
<div class="content">
    <form action="<%=request.getContextPath()%>/consultant/login" method="post">
        <fieldset>
            <legend>Consultant Login</legend>
    ...
    You still do not have a consultant profile?
    <br>
